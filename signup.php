...
if(isset($_POST['submit'])){
    ...
    echo "Password not match";
        ...
        $sql="INSERT INTO users(fullname,username,email,phone,password,confirmpass,gender,terms) 
        VALUES('$fullname','$username','$email','$phone','$password','$cpassword','$gender','$terms')";
        $enter=mysqli_query($con,$sql);
        $_SESSION['username']=$username;
         header('location: signnup.php?username='.$username);
...
<?php
  ...
  <section class="wrapper">
    <form method="post" action="signup.php">
      ...
      <div>
        <input type="checkbox" class="check-box" value="I agree to the terms & conditions" name="terms" required><span> I agree to the terms & conditions</span>
      </div>
      
      <div class="input-box button">
        <input type="submit" name="submit" value="Register">
      </div>
      <a class="create-account-link" href="login.php">Already have an account? Login </a>
    </form>
  </section>
